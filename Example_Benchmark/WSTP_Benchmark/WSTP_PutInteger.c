...
# line 38 "WSTP_PutInteger.c"


void WSTPPutInteger P(( int _tp1));
...
int WSInstall( WSLINK wslp)
{
	int _res;
	_res = WSConnect(wslp);
	if (_res) _res = _definepattern(wslp, (char *)"WSTPPutInteger[x_Integer]", (char *)"{x}", 0);
