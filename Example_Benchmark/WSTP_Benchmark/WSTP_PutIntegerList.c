...
# line 40 "WSTP_PutIntegerList.c"


void WSTPPutIntegerList P(( int _tp1));
...
int WSInstall( WSLINK wslp)
{
	int _res;
	_res = WSConnect(wslp);
	if (_res) _res = _definepattern(wslp, (char *)"WSTPPutIntegerList[x_Integer]", (char *)"{x}", 0);
